  ...
  drawer.innerHTML = `
    ...
    <div class="absolute right-0 top-0 bottom-0 w-4/5 max-w-sm bg-[#fcfbf9] border-l border-stone-200/80 shadow-2xl flex flex-col justify-between p-8 z-10 pointer-events-auto">
      ...
      <nav class="flex flex-col gap-6 py-8 flex-grow">
        ...
        <a href="about.html" class="mobile-nav-link text-lg font-bold text-stone-800 hover:text-[#2d5a27] transition-colors py-2 border-b border-stone-100 flex items-center justify-between">
          About Us
          <i class="fa-solid fa-chevron-right text-xs opacity-40"></i>
        </a>
      ...
      <div class="space-y-6 pt-6 border-t border-stone-200">
        <div class="flex items-center gap-4 text-stone-500">
          <a href="#" class="hover:text-[#2d5a27] transition-colors"><i class="fa-solid fa-globe text-base"></i> Global</a>
          <a href="#" class="hover:text-[#2d5a27] transition-colors"><i class="fa-solid fa-magnifying-glass text-base"></i> Search</a>
        </div>
